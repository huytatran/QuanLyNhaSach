    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="${pageContext.request.contextPath}/sach?action=xuatExcel${not empty tuKhoa ? '&q='.concat(tuKhoa) : ''}${not empty trangThaiLoc and trangThaiLoc != '' ? '&trangThai='.concat(trangThaiLoc) : ''}"
                   ...
                   title="Xuất danh sách sách hiện tại ra file Excel">
        ...
        <div class="card bg-white border mb-3" style="border-color: #e2e8f0; border-radius: 10px;">
            <div class="card-body p-3">
                <form method="get" action="${pageContext.request.contextPath}/sach" class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    <select name="trangThai" class="form-select" style="max-width:180px;font-size:13px;border-color:#cbd5e1;border-radius:6px;">
                        ...
                        <option value="1"  ${trangThaiLoc == '1'  ? 'selected' : ''}>Đang kinh doanh</option>
                        <option value="0"  ${trangThaiLoc == '0'  ? 'selected' : ''}>Ngừng kinh doanh</option>
                    </select>
                    ...
                    <c:if test="${not empty tuKhoa or (not empty trangThaiLoc and trangThaiLoc != '')}">
                        <a href="${pageContext.request.contextPath}/sach" class="btn btn-link text-decoration-none" style="font-size: 13px; color:#64748b;">
