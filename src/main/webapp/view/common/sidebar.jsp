...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white"
     style="width: 280px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 1020; background-color: #0f172a;">
    ...
    <a href="${pageContext.request.contextPath}/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <div class="p-2 rounded-3 me-2 d-flex align-items-center justify-content-center" style="background-color: #4f46e5;">
            <i class="bi bi-briefcase-fill fs-5 text-white"></i>
        </div>
        <span class="fs-5 fw-bold text-slate-100">Portal.BookStore</span>
    </a>
