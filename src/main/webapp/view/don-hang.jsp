...
<head>
    ...
    <style>
        ...
        .badge-trangthai { font-size: 11.5px; font-weight: 600; padding: 5px 10px; border-radius: 999px; }
                ...
                <table class="table mb-0">
                    ...
                    <c:forEach var="dh" items="${danhSachDonHang}">
                        <tr>
                            ...
                            <td class="text-center">
                                <%-- Doi/tra tung mon duoc thao tac trong trang chi tiet don hang --%>
                    ...
                    <c:if test="${empty danhSachDonHang}">
                        <tr>
                            <td colspan="8" class="text-center text-muted py-5">Chưa có đơn hàng nào được ghi nhận.</td>
                        </tr>
                    </c:if>
                    </tbody>
                </table>
