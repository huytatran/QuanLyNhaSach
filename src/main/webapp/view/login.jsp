    ...
    <div class="card-body p-5">
        <div class="text-center mb-4">
            <img src="${pageContext.request.contextPath}/assets/images/logo-mark.svg"
                 ...
                 width="56" height="56"
                 class="mb-3"
                 style="border-radius: 14px; box-shadow: 0 4px 14px rgba(79, 70, 229, 0.25);">
            <h4 class="fw-bold mt-1 mb-1" style="color: #0f172a; letter-spacing: -0.02em;">
                Portal<span style="color: #4f46e5;">.BookStore</span>
            </h4>
            <p class="text-muted mb-0" style="font-size: 13px;">Đăng nhập hệ thống · Cổng nội bộ nhân viên</p>
        </div>
